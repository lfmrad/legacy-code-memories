...
main(void){
    ...
    /*"Do while" principal que permite la repetición de las apuestas 
    hasta que quede dinero.*/
    do{
        //Aleatorios en la repetición del while para que se reinicien cada vez.
        al1=rand()%6+1;
        al2=rand()%6+1;
        ...
        /* Utilizamos un "do while" para volver a lanzar al usuario la cuestión 
        en caso de que nos proporcione un dato incorrecto; en un par de 
        ocasiones he utilizado uno sobre otro porque no me funcionaba el while 
        si le ponía dos condiciones separadas con && */
        ...
        if(a=='a'){
            //Aquí obtenemos los datos necesarios del usuario.
            //OJEAR, NO FUNCIONA
            do{
                do{
                    printf("Combinacion:  ");
            ...
            do{
                do{
                    /*El segundo while limita la apuesta a la mitad del dinero 
                    en caja, como nos pide la práctica.*/
    ...
    /*Finaliza el programa tanto si nos retiramos como si la caja llega 
    a 0 euros; o en caso contrario, lo reinicia.*/
    }while(a!='r'&&x>1);
